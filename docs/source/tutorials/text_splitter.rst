.. raw:: html
   ...
   <div style="display: flex; justify-content: flex-start; align-items: center; margin-bottom: 20px;">
      ...
      <a href="https://github.com/SylphAI-Inc/AdalFlow/blob/main/adalflow/tutorials/adalflow_text_splitter.py" target="_blank" style="display: flex; align-items: center;">
