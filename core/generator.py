...
# class GeneratorOld(Component):
#     r"""
#     A general class for all LLM models. It orchestrates
#     (1) the real model such as openai client, antropic, cohere, etc
#     (2) the input processors, called Prompt
#     (3) the output processors
#     """
...
#     def train(self, *args, **kwargs):
#         # TODO: few-shot sampling for in-context few-shot learning
#         # these can be set as hyper or model parameters
#         pass
