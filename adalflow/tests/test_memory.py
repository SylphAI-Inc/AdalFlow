...
def test_add_user_query_and_assistant_response():
    ...
    # Add second turn
    turn_id2 = memory.add_user_query("Is it easy to learn?")
    memory.add_assistant_response("Yes, Python is known for its simple and readable syntax.")
...
def test_add_assistant_response_with_assistantresponse_object():
    ...
    assistant_response = AssistantResponse(response_str="Response from AssistantResponse object")
...
def test_empty_metadata():
    ...
    cleaned_output = output.replace("User:", "").replace("Assistant:", "").replace("query:", "")
