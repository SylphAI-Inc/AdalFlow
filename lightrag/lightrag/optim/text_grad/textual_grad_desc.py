...
from lightrag.tracing.decorators import trace_generator_states
...
class TextualGradientDescent(Optimizer):
    ...
    def _get_user_prompt_kwargs(self, param: Parameter) -> Dict[str, str]:
        ...
        #     tgd_user_prompt = self.llm_optimizer.get_prompt(**user_prompt_kwargs)
        ...
        # )
        # print(f"Constructed TGD user prompt for {param.role_desc}: {tgd_user_prompt}")
        # return tgd_user_prompt

        # TODO: save gradient memory.
