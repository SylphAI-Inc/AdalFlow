...
# class TestGoogleAIClient(unittest.IsolatedAsyncioTestCase):
#     def setUp(self):
#         self.client = GoogleGenAIClient(api_key="fake_api_key")
#         mock_response = {
...
#     @patch("lightrag.components.model_client.google_client.AsyncGroq")
...
#     @patch("lightrag.components.model_client.groq_client.Groq")
