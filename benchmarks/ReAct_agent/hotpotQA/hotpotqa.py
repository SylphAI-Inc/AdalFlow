...
import dotenv
from components.model_client.openai_client import OpenAIClient
...
# load test data
file = open(
    "./tests/benchmark/ReAct_agent/paper_data/hotpot_dev_v1_simplified_random_100.json"
)
...
gpt_4_turbo_6_shot = experiment(
    num_questions=num_questions,
    dataset=dataset,
    model_kwargs=gpt_4_turbo_model_kwargs,
    examples=examples,
)
